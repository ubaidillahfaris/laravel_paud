     ...
     <aside class="left-sidebar">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                ...
                <li class="sidebar-item">
                    <Link class="sidebar-link" :href="route('dashboard.superadmin')" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <Link class="sidebar-link" :href="route('sekolah.index')" aria-expanded="false">
                    <span>
                    ...
                    <span class="hide-menu">Manjemen Mitra</span>
                    </Link>
                </li>
                <li class="sidebar-item">
